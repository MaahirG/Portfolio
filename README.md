...
### As an intern, I was hands on with the entire ML lifecycle: From research, model implementation, train/test/eval/tune etc, to building an entire system backend interfaceable with a webapp and starting with AI deployment and MLOps.
